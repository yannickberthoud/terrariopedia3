...
class Card(models.Model):
    ...
    day_temperature = models.CharField(max_length=64, verbose_name="Température de jour", help_text="Format : 18°C - 25°C", blank=True)
    night_temperature = models.CharField(max_length=64, verbose_name="Température de nuit",
                                       help_text="Format : 18°C - 25°C", blank=True)
    humidity = models.PositiveIntegerField(verbose_name="Humidité", help_text="Humidité moyenne en %")
    range_humidity = models.CharField(max_length=64, verbose_name="Range d'humidity", help_text="format :50% - 80%",
                                      blank=True)
...
class Amphibian(models.Model):
    ...
    genus = models.CharField(max_length=64, verbose_name="Genre", help_text="Genre")
    species = models.CharField(max_length=64, verbose_name="Espèce", help_text="espèce sous-espèce")
    adult_male_size = models.PositiveIntegerField(verbose_name="Taille adulte mâle", help_text="en mm")
    adult_female_size = models.PositiveIntegerField( verbose_name="Taille adulte femelle", help_text="en mm")
    ...
    night_temperature = models.CharField(max_length=64, verbose_name="Température de nuit",
                                       help_text="Format : 18°C - 25°C", blank=True)
    humidity = models.PositiveIntegerField(verbose_name="Humidité", help_text="Humidité moyenne en %")
    range_humidity = models.CharField(max_length=64, verbose_name="Range d'humidity", help_text="format :50% - 80%", blank=True)
...
class Lizard(models.Model):
    ...
    male_tail_size = models.PositiveIntegerField(verbose_name="Taille de la queue du mâle", help_text="en cm")
    adult_female_size = models.PositiveIntegerField(verbose_name="Taille adulte de la femelle (SVL)", help_text="en cm")
    female_tail_size = models.PositiveIntegerField(verbose_name="Taille de la queue de la femelle", help_text="en cm")
    is_cites = models.BooleanField(verbose_name="Enregistré au CITES")
    annex_cites = models.PositiveIntegerField(verbose_name="Annexe CITES", blank=True, default=0, help_text="0 = rien")
    distribution = models.CharField(max_length=512, help_text="Pays où se trouvent l'espèce", verbose_name="Distribution")
    comments = models.TextField(verbose_name="Commentaire", max_length=500, help_text="Maximum 500 caractères")
