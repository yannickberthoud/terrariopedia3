...
class CardAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        ('Terrarium', {'fields': ['detention_difficulty', 'minimal_vivarium_size', 'day_temperature', 'night_temperature', 'range_humidity', 'temperature_high', 'temperature_low', 'humidity']}),
        ('Image', {'fields': ['image']}),
...
class AmphibienAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        ('Terrarium', {'fields': ['detention_difficulty', 'minimal_vivarium_size', 'day_temperature', 'night_temperature', 'range_humidity', 'temperature_high', 'temperature_low', 'humidity', 'life_community']}),
